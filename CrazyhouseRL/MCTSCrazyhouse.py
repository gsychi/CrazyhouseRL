...
class MCTS():
    ...
    def simulateTrainingGame(self, playouts, round="1"):
        ...
        while sim.result == 2:
            ...
            index = np.argmax(
                PUCT_Algorithm(self.childrenStateWin[directory], self.childrenStateSeen[directory], 0.22,  # 0.25-0.30 guarantees diversity
                               np.sum(self.childrenStateSeen[directory]),
...
treeSearch.simulateCompetitiveGame(10)
