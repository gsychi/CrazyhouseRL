...
class ChessEnvironment():
    ...
    def makeMove(self, move):
        if chess.Move.from_uci(move) in self.board.legal_moves:
            ...
            #white en passant
            elif self.arrayBoard[initialRow][initialCol] == "P" and self.arrayBoard[initialRow][finalCol] == "p" and self.arrayBoard[finalRow][finalCol] == " ":
    ...
    def boardToState(self):
        ...
        #then, update knights, bishops, and rooks.
        for i in range(4):
            if temp1[1] > 0:
